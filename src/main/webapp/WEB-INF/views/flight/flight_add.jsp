...
<title>Online Ticket Reservation System 2016 </title>
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3">
				<h2 class="lead">Online Ticket Reservation System </h2>
			...
			<div class="col-md-9">
				...
				<div class="jumbotron">
					<h2><span class="glyphicon glyphicon-user"></span>Flight Schedule</h2>
				...
				<form:form modelAttribute="newFlight" cssClass="form">
					<div class="well">
						<div class="row">
							<div class="col-md-12">
								<span class="glyphicon glyphicon-star"></span> provide All the information here
                   ...
                   <div class="col-lg-10">
					...
					<div class="col-lg-10">
						<label for="tags">Total_Seats</label>
					...
					<div class="col-lg-10">
						<label for="tags"> Price_Flight </label>
