	...
	<tbody>
		<%--<c:forEach items="${tickets}" var="ticket">--%>
			<tr>
				...
				<td><c:out value="${ticket.flight.price}" /></td>
                                <td><c:out value="${ticket.flight.flight_ID}" /></td>
...
<!--				<td>
					...
					<button class="btn btn-cicle btn-xs btn-danger" onclick="doDelete(${flight.flight_ID})">Del</button>
                           ...
                           <td>
                             <a href="${pageContext.request.contextPath}/ticket/cancel/${ticket.ticket_ID}">
			<button class="btn btn-cicle btn-xs btn-info">CANCEL</button>
					</a></td>
			...
			<button class="btn btn-primary">HOME</button>
                             ...
                             <a href="${pageContext.request.contextPath}/passenger/logout">
