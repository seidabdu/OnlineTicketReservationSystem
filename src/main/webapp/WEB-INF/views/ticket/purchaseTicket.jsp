	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3">
				...
				<div class="list-group">
					<a href="${pageContext.request.contextPath}/flight" class="list-group-item">HOME</a> <a
						href="${pageContext.request.contextPath}/flight/add" class="list-group-item active">Admin</a>
				</div>
			</div>
			...
			<div class="col-md-9">
				...
				<div class="jumbotron">
					<h2><span class="glyphicon glyphicon-user"></span> Purchase Ticket Online Ticketing</h2>
				</div>

				<form:form modelAttribute="purchaseTicket" cssClass="form">
					<div class="well">
						<div class="row">
							<div class="col-md-12">
								<span class="glyphicon glyphicon-star"></span> here is Your Tickt ID
					...
					<div class="form-group">
						<label for="title">Ticket_ID </label>
						<!--  <input type="text" class="form-control" name="name" id="name" placeholder="Name of contact person" value="" required /> -->
						<form:input path="ticket_ID" cssClass="form-control" placeholder="Ticket_ID" required="required" />
						<form:errors path="ticket_ID" cssClass="has-error" />
					</div>
